	...
	<table align="center">		
		<tr>
			<td>
				...
				<br/><br/>
				<?php echo $lang['FORGOT_PASSWORD']; ?> ? <a href="<?php echo URL_DIR.'/login/resetpassword';?>">(<?php echo $lang['RESET_PASSWORD']; ?>)</a><br>
				<?php echo $lang['NO_ACCOUNT']; ?> ? <a href="<?php echo URL_DIR.'/login/newuser';?>">(<?php echo $lang['REGISTER']; ?>)</a>
			</td>
		</tr>
	</table>
</form>
